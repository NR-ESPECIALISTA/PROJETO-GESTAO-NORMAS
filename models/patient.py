...
class HospitalPatient(models.Model):
    ...
    # ------------------------------------------
    insp_cal_med_esp_esquerdo_0 = fields.Float(string="Ponto 1 (0º)")
    insp_cal_med_esp_esquerdo_90 = fields.Float(string="Ponto 2 (90º)")
    insp_cal_med_esp_esquerdo_180 = fields.Float(string="Ponto 2 (180º)")
    insp_cal_med_esp_esquerdo_270 = fields.Float(string="Ponto 4 (270º)")

    insp_cal_med_esp_direito_0 = fields.Float(string="Ponto 4 (0º)")
    insp_cal_med_esp_direito_90 = fields.Float(string="Ponto 4 (90º)")
    insp_cal_med_esp_direito_180 = fields.Float(string="Ponto 4 (180º)")
    insp_cal_med_esp_direito_270 = fields.Float(string="Ponto 4 (270º)")

    insp_cal_med_esp_tubo_0 = fields.Float(string="Ponto 1 (0º)")
    insp_cal_med_esp_tubo_90 = fields.Float(string="Ponto 2 (90º)")
    insp_cal_med_esp_tubo_180 = fields.Float(string="Ponto 3 (180º)")
    insp_cal_med_esp_tubo_270 = fields.Float(string="Ponto 4 (270º)")

    insp_cal_med_esp_costado_0 = fields.Float(string="Ponto 1 (0º)")
    insp_cal_med_esp_costado_90 = fields.Float(string="Ponto 2 (90º)")
    insp_cal_med_esp_costado_180 = fields.Float(string="Ponto 3 (180º)")
    insp_cal_med_esp_costado_270 = fields.Float(string="Ponto 4 (270º)")

    # ------------------------------------------
    # | Inspeção da Caldeira                   |
    # | Teste Hidrostático                     |
    # ------------------------------------------
    insp_cal_th_fluido_teste = fields.Selection([
        ('agua', 'Água')], string="Fluído de Teste")
    insp_cal_th_press_trabalho = fields.Float(
        string="Pressão de Trabalho (Kgf/cm²)")
    insp_cal_th_press_teste = fields.Float(string="Pressão de Teste (kgf/cm²)")
    insp_cal_th_desenho = fields.Char(string="Desenho n°")
    insp_cal_th_manometro = fields.Selection([
        ('MN-001', 'MN-001'),
        ('MN-002', 'MN-002'),
        ('MN-003', 'MN-003')], string="Manômetros Nº")
    insp_cal_th_croqui = fields.Char(
        string="Croqui / Fluxograma do Sistema de Teste")
    insp_cal_th_img_1 = fields.Image(string="Teste Hidrostático - Imagem 1")
    insp_cal_th_img_2 = fields.Image(string="Teste Hidrostático - Imagem 2")
    insp_cal_th_img_3 = fields.Image(string="Teste Hidrostático - Imagem 3")
    insp_cal_th_img_4 = fields.Image(string="Teste Hidrostático - Imagem 4")
    insp_cal_th_img_5 = fields.Image(string="Teste Hidrostático - Imagem 5")
    insp_cal_th_laudo = fields.Selection([
        ('aprovado', 'Aprovado'),
    ...
    insp_cal_lp_penetrante_modelo = fields.Char(string="Modelo")
    insp_cal_lp_penetrante_validade_date = fields.Date(string="Validade")
    insp_cal_lp_penetrante_lote = fields.Char(string="Lote")
    insp_cal_lp_penetrante_tempo = fields.Integer(
        string="Tempo de Ação do Penetrante (minutos)")

    # insp_cal_lp_revelador_fabricante_ids = fields.Many2many(string="Fabricante")
    insp_cal_lp_revelador_modelo = fields.Char(string="Modelo")
    insp_cal_lp_revelador_validade_date = fields.Date(string="Validade")
    insp_cal_lp_revelador_lote = fields.Char(string="Lote")
    insp_cal_lp_revelador_tempo = fields.Integer(
        string="Tempo de Avaliação  (minutos)")

    insp_cal_lp_removedor_tipo = fields.Selection([
        ('agua', 'Água'),
        ('solvente', 'Solvente')], string="Tipo")
    insp_cal_lp_removedor_validade_date = fields.Date(string="Validade")
    insp_cal_lp_removedor_lote = fields.Char(string="Lote")
    insp_cal_lp_removedor_temperatura = fields.Char(string="Temperatura")

    insp_cal_lp_obs_comentarios = fields.Char(
        string="Observações / Comentários")

    insp_cal_lp_img_1 = fields.Image(string="Liquido Penetrante - Imagem 1")
    insp_cal_lp_img_2 = fields.Image(string="Liquido Penetrante - Imagem 2")
    insp_cal_lp_img_3 = fields.Image(string="Liquido Penetrante - Imagem 3")
    insp_cal_lp_img_4 = fields.Image(string="Liquido Penetrante - Imagem 4")
    insp_cal_lp_img_5 = fields.Image(string="Liquido Penetrante - Imagem 5")
    insp_cal_lp_img_6 = fields.Image(string="Liquido Penetrante - Imagem 6")
    insp_cal_lp_img_7 = fields.Image(string="Liquido Penetrante - Imagem 7")
    insp_cal_lp_img_8 = fields.Image(string="Liquido Penetrante - Imagem 8")
    insp_cal_lp_img_9 = fields.Image(string="Liquido Penetrante - Imagem 9")
    insp_cal_lp_img_10 = fields.Image(string="Liquido Penetrante - Imagem 10")
    insp_cal_lp_img_11 = fields.Image(string="Liquido Penetrante - Imagem 11")
    insp_cal_lp_img_12 = fields.Image(string="Liquido Penetrante - Imagem 12")
    insp_cal_lp_img_13 = fields.Image(string="Liquido Penetrante - Imagem 13")
    insp_cal_lp_img_14 = fields.Image(string="Liquido Penetrante - Imagem 14")
    insp_cal_lp_img_15 = fields.Image(string="Liquido Penetrante - Imagem 15")

    insp_cal_lp_revelador_img_1 = fields.Image(string="Revelador - Imagem 1")
    insp_cal_lp_revelador_img_2 = fields.Image(string="Revelador - Imagem 2")
    insp_cal_lp_revelador_img_3 = fields.Image(string="Revelador - Imagem 3")
    insp_cal_lp_revelador_img_4 = fields.Image(string="Revelador - Imagem 4")
    insp_cal_lp_revelador_img_5 = fields.Image(string="Revelador - Imagem 5")
    insp_cal_lp_revelador_img_6 = fields.Image(string="Revelador - Imagem 6")
    insp_cal_lp_revelador_img_7 = fields.Image(string="Revelador - Imagem 7")
    insp_cal_lp_revelador_img_8 = fields.Image(string="Revelador - Imagem 8")
    insp_cal_lp_revelador_img_9 = fields.Image(string="Revelador - Imagem 9")
    insp_cal_lp_revelador_img_10 = fields.Image(string="Revelador - Imagem 10")
    insp_cal_lp_revelador_img_11 = fields.Image(string="Revelador - Imagem 11")
    insp_cal_lp_revelador_img_12 = fields.Image(string="Revelador - Imagem 12")
    insp_cal_lp_revelador_img_13 = fields.Image(string="Revelador - Imagem 13")
    insp_cal_lp_revelador_img_14 = fields.Image(string="Revelador - Imagem 14")
    insp_cal_lp_revelador_img_15 = fields.Image(string="Revelador - Imagem 15")
