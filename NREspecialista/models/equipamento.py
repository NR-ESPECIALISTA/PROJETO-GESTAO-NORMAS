...
class NrEquipamento(models.Model):
    ...
    #activity_ids = fields.One2many('mail.activity', 'res_id', string="Atividades", domain=[('res_model', '=', 'nr.equipamento')])
    ...
    # task_activity_type = fields.Many2one('mail.activity.mixin', string="")

    #activity_type_id = fields.Many2one(
    #    'mail.activity', related='activity_ids.activity_type_id', readonly=True,
    #    search='_search_activity_type_id',
    #    groups="base.group_user")

    imagem_equip = fields.Image(string="Image", stored=True)
    name = fields.Char(string="Nome do Equipamento",
                       required=True, copy=False, index=True, searchable=True)  # tracking=True
