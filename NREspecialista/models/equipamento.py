...
class NrEquipamento(models.Model):
    ...
    tipo_equip = fields.Selection(
        [('caldeira', 'CALDEIRA'),
         ...
         ('psv', 'PSV'),
         ('pi', 'PI'),
         ('outros', 'OUTROS')], string='Tipo de Equipamento')
    ...
    ano_fabri = fields.Char(string="Ano de Fabricação")
    pressao_de_trabalho = fields.Char(string="Pressão de Trabalho")
    pmta = fields.Char(string="PMTA")
    pressao_ajuste = fields.Char(string="Pressão de Ajuste")
    ...
    def action_inspecao(self):
        return {'name': ('Inspeção'),
                'res_model': 'equip.inspecao',
                'view_mode': 'list,form',
                'context': {},
                'target': 'current',
                'type': 'ir.actions.act_window', }

    equip_inspecao = fields.Integer(string="Inspeção")

    def action_documentacao(self):
        return {'name': ('Documentação'),
                'res_model': 'equip.documentacao',
                'view_mode': 'list,form',
                'context': {},
                'target': 'current',
                'type': 'ir.actions.act_window', }

    equip_documentacao = fields.Integer(string="Documentação")

    def action_vinculo(self):
        return {'name': ('Vínculo'),
                'res_model': 'equip.vinculo',
                'view_mode': 'list,form',
                'context': {},
                'target': 'current',
                'type': 'ir.actions.act_window', }

    equip_vinculo = fields.Integer(string="Vínculo")

    def action_plano_acao(self):
        return {'name': ('Plano de Ação'),
                'res_model': 'equip.plano_acao',
                'view_mode': 'list,form',
                'context': {},
                'target': 'current',
                'type': 'ir.actions.act_window', }

    equip_plano_acao = fields.Integer(string="Plano de Ação")
